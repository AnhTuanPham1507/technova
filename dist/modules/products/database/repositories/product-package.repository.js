...
const product_package_entity_1 = require("../entities/product-package.entity");
let ProductPackageRepository = class ProductPackageRepository {
    constructor(productPackageRepo) {
...
ProductPackageRepository = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(product_package_entity_1.ProductPackageEntity)),
