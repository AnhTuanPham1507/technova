...
class AbstractDTO {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, createdAt: { required: false, type: () => Date }, updatedAt: { required: false, type: () => Date }, deletedAt: { required: false, type: () => Date } };
    }
}
__decorate([
...
__decorate([
    (0, swagger_1.ApiProperty)({ name: 'createdAt' }),
    __metadata("design:type", Date)
], AbstractDTO.prototype, "createdAt", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ name: 'updatedAt' }),
    __metadata("design:type", Date)
], AbstractDTO.prototype, "updatedAt", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ name: 'deletedAt' }),
    __metadata("design:type", Date)
